...
$settings_dto->ajax_signed_title !== '' ? $settings_dto->ajax_signed_title : '已收到您的合約簽屬，等待審閱!',
...
$settings_dto->ajax_signed_description !== '' ? $settings_dto->ajax_signed_description : '審閱完成後會立即通知您，並為您開通課程',
