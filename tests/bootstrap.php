 ...
 * 順序：Powerhouse → Power Contract
 */
function _power_contract_manually_load_plugin(): void {
	...
	// 2. 載入 Power Contract plugin
	require dirname( __DIR__ ) . '/plugin.php';
}

tests_add_filter( 'muplugins_loaded', '_power_contract_manually_load_plugin' );
 ...
 */
function _power_contract_force_bootstrap(): void {
	if ( class_exists( 'J7\PowerContract\Bootstrap' ) ) {
		\J7\PowerContract\Bootstrap::instance();
	}
}

tests_add_filter( 'plugins_loaded', '_power_contract_force_bootstrap', 20 );
